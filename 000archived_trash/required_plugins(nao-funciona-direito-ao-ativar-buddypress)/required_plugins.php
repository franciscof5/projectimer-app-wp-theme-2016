...
add_action( 'tgmpa_register', 'projectimer_register_required_plugins' );
 ...
 */
function projectimer_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'Projectimer-loader',                 // Unique ID for hashing notices for multiple instances of TGMPA.
