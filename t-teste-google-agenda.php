<?php
/* Template Name: Pomo - Focar com Google Agenda */
?>
<?php get_header() ?>
...
$client->setClientId('52781640120-k59n3f9egmmr5f72nijn2u61oq3crgs2.apps.googleusercontent.com');
$client->setClientSecret('niJrWQlbrvYlnfXGf96XhAwW');
$client->setRedirectUri('https://www.pomodoros.com.br/oauth2callback');
