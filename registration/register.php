	...
	<div id="content_register">
		...
		<div class="page" id="register-page">
			<div class="register_div_box" id="rbox1">
				<h2><?php _e("Social login"); ?></h2>
				<p><?php _e( 'We currently allow Facebook login with a single click.', 'projectimer-theme' ); ?></p>
				<br />
				<center>
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<h2><?php _e( 'New account', 'projectimer-theme' ); ?></h2>

				<?php do_action( 'template_notices' ); ?>

				<p><?php _e( 'Just fill in the fields below and get a new account.', 'projectimer-theme' ); ?></p>
				...
				<input class="btn btn-default register_submit_button" type="submit" name="signup_submit" id="signup_submit" value="<?php _e( 'Complete Sign Up', 'buddypress' ); ?>" />
